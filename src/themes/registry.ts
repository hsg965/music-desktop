...
export const SKINS: SkinDefinition[] = [
  {
    ...
    tokens: darkTokens({
      bg: "#121212",
      "sider-bg": "rgba(255,255,255,0.06)",
      "bar-bg": "rgba(8,8,10,0.28)",
      primary: "#1db954",
  ...
  },
  {
    ...
    tokens: darkTokens({
      bg: "#141414",
      "sider-bg": "rgba(255,200,200,0.07)",
      "bar-bg": "rgba(18,10,10,0.3)",
      primary: "#ec4141",
  ...
  },
  {
    ...
    tokens: darkTokens({
      bg: "#0f1419",
      "sider-bg": "rgba(160,200,255,0.07)",
      "bar-bg": "rgba(8,12,18,0.3)",
      primary: "#3d8bfd",
  ...
  },
  {
    ...
    tokens: darkTokens({
      bg: "#1c1e22",
      "sider-bg": "rgba(255,255,255,0.07)",
      "bar-bg": "rgba(14,16,20,0.3)",
      primary: "#a8b0bc",
  ...
  },
  {
    ...
    tokens: lightTokens({
      bg: "#f3f0ea",
      "sider-bg": "rgba(255,252,247,0.4)",
      "bar-bg": "rgba(255,250,244,0.3)",
      primary: "#b45309",
  ...
  },
  {
    ...
    tokens: lightTokens({
      bg: "#fff6d6",
      "sider-bg": "rgba(255,248,230,0.4)",
      "bar-bg": "rgba(255,246,220,0.32)",
      primary: "#d97706",
  ...
  },
  {
    ...
    tokens: darkTokens({
      bg: "#0f1a14",
      "sider-bg": "rgba(140,200,160,0.08)",
      "bar-bg": "rgba(8,16,12,0.32)",
      primary: "#3d8f6a",
